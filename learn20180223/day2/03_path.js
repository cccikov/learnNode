...
/////////////////////////////////////////////////////////
// node有许多需要用到路径的地方，比如require()，require的路径是用当前文件所在目录出发 //
/////////////////////////////////////////////////////////
var fs = require("fs");
var m2 = require("./module2"); //require默认是用当前文件所在目录出发
...
/////////////////////////////////////////////////////
// 使用readFile 推荐使用绝对路径，__dirname就是返回当前文件所在的目录的绝对路径 //
/////////////////////////////////////////////////////
...
/*
 * 那么如果，fs读取的文件不是在当前文件目录或当前文件目录下面的呢；而是需要去到当前文件目录更上层的目录寻找的呢
 * 就可以使用path.resolve()方法
 */

console.log(__dirname); // 当前文件目录
console.log(path.resolve(__dirname, "./")); // 当前文件目录
console.log(path.resolve(__dirname, "../")); // 当前文件的上一层目录
